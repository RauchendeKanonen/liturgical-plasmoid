...
declare class Dates {
	...
	lunarNewYear: (utcOffset: number, year?: number) => Date;
	static lunarNewYear: (utcOffset: number, year: number) => Date;
	sundayOnOrAfterLunarNewYear: (utcOffset: number, year?: number) => Date;
...
export declare class Romcal {
	...
	static computeLunarNewYear: (utcOffset: number, year: number) => Date;
	...
	static LOCALES: Record<string, Locale>;
}
